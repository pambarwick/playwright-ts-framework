...
export class CheckoutPage extends BasePage {
  ...
  async assertSummaryContains(productName: string, price: string) {
    await expect(this.summaryItemNames.filter({ hasText: productName })).toBeVisible();
    await expect(this.itemTotal).toContainText(price);
  }
